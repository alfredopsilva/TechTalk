      ...
      <div className="space-y-5">
        ...
        {isLoading ? (
          <div className="flex-center flex-col px-5">
            ...
            <p className="text-dark-200 dark:text-light-800 font-regular">
              Browsing the entire application...
            </p>
          </div>
        ) : (
          <div className="flex flex-col gap-2">
            {result.length > 0 ? (
              ...
              <div>
                <p className="text-dark-200 dark:text-light-800 font-regular px-5 py-2.5">
